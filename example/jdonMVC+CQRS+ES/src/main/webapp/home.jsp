...
<shiro:user><p>Visit your <a href="<c:url value="/user"/>">user page</a>.</p></shiro:user>
<shiro:guest><p>If you want to access the user-only <a href="<c:url value="/user"/>">user page</a>,
